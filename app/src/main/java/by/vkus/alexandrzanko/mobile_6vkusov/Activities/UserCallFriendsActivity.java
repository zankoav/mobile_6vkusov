...
public class UserCallFriendsActivity extends AppCompatActivity {
    ...
    private void getFriends() {
        ...
        if(Validation.email(emailFriend)){
            ApiController.getApi().callFriend(Singleton.currentState().getIUser().getSession(),emailFriend).enqueue(new Callback<String>() {
                @Override
                public void onResponse(Call<String> call, Response<String> response) {
                    ...
                    if (response.code() == 200){
                        ...
                        Toast toast = Toast.makeText(UserCallFriendsActivity.this,UserCallFriendsActivity.this.getResources().getString(R.string.error_server), Toast.LENGTH_SHORT);
                        toast.show();
                    }else if(response.code() == 394){
                        Toast toast = Toast.makeText(UserCallFriendsActivity.this,UserCallFriendsActivity.this.getResources().getString(R.string.error_friend_exists), Toast.LENGTH_SHORT);
                        toast.show();
                    }else if(response.code() == 393){
                        Toast toast = Toast.makeText(UserCallFriendsActivity.this,UserCallFriendsActivity.this.getResources().getString(R.string.error_friend_limit), Toast.LENGTH_SHORT);
                        toast.show();
                    }
                    btn.setEnabled(true);
                }
