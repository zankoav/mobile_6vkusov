...
import by.vkus.alexandrzanko.mobile_6vkusov.Fragments.GetPointsFragment;
...
public class ProfileActivity extends AppCompatActivity implements AppBarLayout.OnOffsetChangedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(by.vkus.alexandrzanko.mobile_6vkusov.R.layout.activity_profile);
        bindActivity();
        mAppBarLayout.addOnOffsetChangedListener(this);
        startAlphaAnimation(mTitle, 0, View.INVISIBLE);
        mToolbar.setNavigationIcon(by.vkus.alexandrzanko.mobile_6vkusov.R.drawable.ic_menu);
        ...
        try {
            ...
            String url =  this.getResources().getString(by.vkus.alexandrzanko.mobile_6vkusov.R.string.api_base) + profile.getString("img_path")+"/"+profile.getString("avatar");
            mTitle.setText(name);
    ...
    private void bindActivity() {
        mToolbar        = (Toolbar) findViewById(by.vkus.alexandrzanko.mobile_6vkusov.R.id.main_toolbar);
        mTitle          = (TextView) findViewById(by.vkus.alexandrzanko.mobile_6vkusov.R.id.main_textview_title);
        mNameUser       = (TextView) findViewById(by.vkus.alexandrzanko.mobile_6vkusov.R.id.user_first_name);
        subTitle        = (TextView) findViewById(by.vkus.alexandrzanko.mobile_6vkusov.R.id.user_email_small);
        bonusCount      = (TextView) findViewById(by.vkus.alexandrzanko.mobile_6vkusov.R.id.bonus_count);
        mTitleContainer = (LinearLayout) findViewById(by.vkus.alexandrzanko.mobile_6vkusov.R.id.main_linearlayout_title);
        mAppBarLayout   = (AppBarLayout) findViewById(by.vkus.alexandrzanko.mobile_6vkusov.R.id.main_appbar);
        circleImageView = (CircleImageView)findViewById(by.vkus.alexandrzanko.mobile_6vkusov.R.id.user_icon);
    }
