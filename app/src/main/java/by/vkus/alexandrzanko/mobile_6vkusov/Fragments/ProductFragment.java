...
public class ProductFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(by.vkus.alexandrzanko.mobile_6vkusov.R.layout.fragment_product_layout, container, false);
        return rootView;
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        listView = (ListView) getView().findViewById(by.vkus.alexandrzanko.mobile_6vkusov.R.id.product_list_view);
