...
public class AvatarImageBehavior extends CoordinatorLayout.Behavior<CircleImageView> {
    ...
    public AvatarImageBehavior(Context context, AttributeSet attrs) {
        ...
        mFinalLeftAvatarPadding = context.getResources().getDimension(
                by.vkus.alexandrzanko.mobile_6vkusov.R.dimen.spacing_normal);
    }
    ...
    private void bindDimensions() {
        mAvatarMaxSize = mContext.getResources().getDimension(by.vkus.alexandrzanko.mobile_6vkusov.R.dimen.image_width);
    }
    ...
    private void maybeInitProperties(CircleImageView child, View dependency) {
        ...
        if (mFinalXPosition == 0){
            mFinalXPosition = mContext.getResources().getDimensionPixelOffset(by.vkus.alexandrzanko.mobile_6vkusov.R.dimen.appbar_circle_view_left) - ((int) mCustomFinalHeight) - 4;
        }
