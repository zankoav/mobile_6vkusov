...
import by.netbix.alexandrzanko.mobile_6vkusov.Adapters.OrderAdapter;
...
public class OrderFragment extends Fragment implements LoadJson {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(by.netbix.alexandrzanko.mobile_6vkusov.R.layout.fragment_orders_layout, container, false);
        listView = (ListView)rootView.findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.listView);
        return rootView;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        String url = getContext().getResources().getString(by.netbix.alexandrzanko.mobile_6vkusov.R.string.api_orders);
