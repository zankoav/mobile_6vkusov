...
import by.netbix.alexandrzanko.mobile_6vkusov.Activities.AuthActivities.LoginActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(by.netbix.alexandrzanko.mobile_6vkusov.R.layout.activity_main);
        generalMenu = (LinearLayout)findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.generalMenu);
        registerMenu = (LinearLayout)findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.registerMenu);
        loginOrProfile = (TextView) findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.btn_login);
        userLogo = (ImageView)findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.iv_user);
        lunchScreen = (ImageView)findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.iv_lunchScreen);
    ...
    public void loadComplete(){
        ...
        if (singleton.getUser().getStatus() == STATUS.GENERAL ){
            userLogo.setImageDrawable(ContextCompat.getDrawable(this, by.netbix.alexandrzanko.mobile_6vkusov.R.drawable.ic_avatar));
            ...
            try {
                ...
                String urlIcon = this.getResources().getString(by.netbix.alexandrzanko.mobile_6vkusov.R.string.api_base) + userJson.getString("img_path")+"/"+ userJson.getString("avatar");
                Picasso.with(this)
                        .load(urlIcon)
