...
import by.netbix.alexandrzanko.mobile_6vkusov.Fragments.ProductFragment;
...
public class ProductsAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView = layoutInflater.inflate(by.netbix.alexandrzanko.mobile_6vkusov.R.layout.product_item_layout, null);
        holder = new ViewHolder();

        holder.productImg           = (ImageView) convertView.findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.product_icon);
        holder.productName          = (TextView) convertView.findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.product_name);
        holder.productDescription   = (TextView) convertView.findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.product_description);
        holder.addToBasketButton    = (Button) convertView.findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.product_add_basket);
        holder.variantsListView     = (ListView) convertView.findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.product_variants);
        ...
        if (category.equals("Еда за баллы")){
            if (Singleton.currentState().getUser().getStatus() == STATUS.GENERAL){
                ...
                holder.addToBasketButton.setBackgroundResource(by.netbix.alexandrzanko.mobile_6vkusov.R.drawable.shape_corner);
