...
public class InfoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(by.netbix.alexandrzanko.mobile_6vkusov.R.layout.fragment_restaurant_info_layout, container, false);
        textView = (TextView)rootView.findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.textView);
