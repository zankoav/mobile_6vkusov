...
public class ProductActivity extends AppCompatActivity implements BasketViewInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(by.netbix.alexandrzanko.mobile_6vkusov.R.layout.activity_product);
        addToolBarToScreen();
        slug = getIntent().getStringExtra(EXTRA_SLUG);
        category = getIntent().getIntExtra(EXTRA_CATEGORY,0);
        viewPager = (ViewPager)findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.viewpager_products);
    ...
    private void addToolBarToScreen() {
        ...
        toolbar.setTitle(by.netbix.alexandrzanko.mobile_6vkusov.R.string.rest_menu);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        countProducts = (TextView) notificationCount.findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.notif_count);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == by.netbix.alexandrzanko.mobile_6vkusov.R.id.shopping_cart) {
            // action
            return true;
        }
