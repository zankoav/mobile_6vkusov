...
public class BasketAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView = layoutInflater.inflate(by.netbix.alexandrzanko.mobile_6vkusov.R.layout.product_item_basket_layout, null);
        ...
        holder.productWidth    = (TextView) convertView.findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.product_width);
        holder.productPrice    = (TextView) convertView.findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.product_price);
        holder.countProducts   = (TextView) convertView.findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.product_count);
        ...
        holder.btnRemove       = (Button) convertView.findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.product_btn_remove);
