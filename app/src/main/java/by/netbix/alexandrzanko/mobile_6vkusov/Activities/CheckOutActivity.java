...
public class CheckOutActivity extends AppCompatActivity implements LoadJson {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(by.netbix.alexandrzanko.mobile_6vkusov.R.layout.activity_check_out);
        addToolBarToScreen();
        name = (EditText)findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.order_user_name);
        phone = (EditText)findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.order_user_phone);
        street = (EditText)findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.order_user_street);
        house = (EditText)findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.order_user_house);
        block = (EditText)findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.order_user_block);
        flat = (EditText)findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.order_user_flat);
        comment = (EditText)findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.order_user_comments);
    ...
    private void addToolBarToScreen() {
        ...
        toolbar.setTitle(by.netbix.alexandrzanko.mobile_6vkusov.R.string.order_title);
    ...
    public void buttonPressed(View view) {
        ...
        if (validateData(phone, street)) {
            ...
            String url = this.getResources().getString(by.netbix.alexandrzanko.mobile_6vkusov.R.string.api_send_order);
            try {
...
//                params.put("delivery-type", "тип доставки, самовывоз, значения 1 или 2");
                ...
                if (Singleton.currentState().getUser().getStatus() == STATUS.GENERAL){
                    ...
                    url = this.getResources().getString(by.netbix.alexandrzanko.mobile_6vkusov.R.string.api_checkout_cart);
