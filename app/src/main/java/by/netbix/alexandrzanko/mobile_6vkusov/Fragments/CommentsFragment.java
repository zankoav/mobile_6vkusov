...
import by.netbix.alexandrzanko.mobile_6vkusov.Adapters.CommentsAdapter;
import by.netbix.alexandrzanko.mobile_6vkusov.Models.Comment;
...
public class CommentsFragment extends Fragment implements LoadJson {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (comments == null){
            ...
            String url = getResources().getString(by.netbix.alexandrzanko.mobile_6vkusov.R.string.api_restaurant_comments);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(by.netbix.alexandrzanko.mobile_6vkusov.R.layout.fragment_restaurant_comments_layout, container, false);
        return rootView;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        listView = (ListView) getView().findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.listComments);
    ...
    public void loadComplete(JSONObject obj, String sessionName) {
        try {
            if (obj != null) {
                String baseUrl =getResources().getString(by.netbix.alexandrzanko.mobile_6vkusov.R.string.api_base) + "/" +  obj.getString("img_path");
