...
import by.netbix.alexandrzanko.mobile_6vkusov.Fragments.AlertCommentsDialog;
import by.netbix.alexandrzanko.mobile_6vkusov.Fragments.OrderFragment;
import by.netbix.alexandrzanko.mobile_6vkusov.Models.OrderItem;
import by.netbix.alexandrzanko.mobile_6vkusov.Models.OrderItemFood;
...
public class OrderAdapter extends BaseAdapter  implements LoadJson {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView = layoutInflater.inflate(by.netbix.alexandrzanko.mobile_6vkusov.R.layout.order_item_layout, null);
        holder = new OrderAdapter.ViewHolder();

        holder.restImg = (ImageView) convertView.findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.restaurants_icon);
        holder.orderName = (TextView) convertView.findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.restaurants_name);
        holder.orderDate = (TextView) convertView.findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.order_date);
        holder.orderPrice = (TextView) convertView.findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.price);
        holder.itemsListView = (ListView) convertView.findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.foodListView);
        holder.commentBtn = (Button) convertView.findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.button_comment);
