...
import by.netbix.alexandrzanko.mobile_6vkusov.Activities.RestaurantsCardActivity;
...
public class RestaurantRecycleAdapter extends RecyclerView.Adapter<RestaurantRecycleAdapter.ViewHolder>  implements Filterable{
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(by.netbix.alexandrzanko.mobile_6vkusov.R.layout.card_restaurant_layout,parent, false);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view){
                ...
                nameTV = (TextView) view.findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.restaurants_name);

                kitchenType = (TextView) view.findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.restaurants_kitchen_type);

                workTimeTitleTV = (TextView) view.findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.restaurants_work_time_title);
                workTimeTV = (TextView) view.findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.restaurants_work_time);

                timeTitleTV = (TextView) view.findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.restaurants_delivery_time_title);
                timeTV = (TextView) view.findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.restaurants_delivery_time);

                deliveryTitleType = (TextView) view.findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.restaurants_min_price_title);
                deliveryType = (TextView) view.findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.restaurants_min_price);

                imageView = (ImageView) view.findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.restaurants_icon);

                likesTV = (TextView) view.findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.restaurants_likes);
                dislikesTV = (TextView) view.findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.restaurants_dislike);
