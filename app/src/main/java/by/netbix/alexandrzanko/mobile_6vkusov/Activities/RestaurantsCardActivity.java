...
import by.netbix.alexandrzanko.mobile_6vkusov.Adapters.RestaurantRecycleAdapter;
...
public class RestaurantsCardActivity extends AppCompatActivity implements LoadJson {
    ...
    public void onResume() {
        ...
        if (isFavorite) {
            ...
            if (Singleton.currentState().getUser().getStatus() == STATUS.REGISTER) {
                ...
                String url = this.getResources().getString(by.netbix.alexandrzanko.mobile_6vkusov.R.string.api_favourites);
                try {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(by.netbix.alexandrzanko.mobile_6vkusov.R.layout.activity_restaurant_new);
    ...
    public int getToolBarHeight() {
        int[] attrs = new int[] {by.netbix.alexandrzanko.mobile_6vkusov.R.attr.actionBarSize};
    ...
    private void initViews(){
        filterView = (LinearLayout)findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.filter_view);
        allView = (LinearLayout)findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.all_view);
        recyclerView = (RecyclerView)findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.recycler_view);

        seekBarResult = (TextView) findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.seekBar_result);
        seekBar = (SeekBar) findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.seekBar);
        ...
        checkNew = (CheckBox) findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.check_box_new);
        ...
        checkFreeFood = (CheckBox) findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.check_box_free_food);
        ...
        checkFlash = (CheckBox) findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.check_box_flash);
        ...
        checkSale = (CheckBox) findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.check_box_sale);
    ...
    private void changeIconFilter(){
        if(isFilterFull()){
           search.setIcon(by.netbix.alexandrzanko.mobile_6vkusov.R.drawable.ic_filter_full);
        }else{
            search.setIcon(by.netbix.alexandrzanko.mobile_6vkusov.R.drawable.ic_filter_clear);
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(by.netbix.alexandrzanko.mobile_6vkusov.R.menu.action_bar, menu);
        MenuItem item = menu.findItem(by.netbix.alexandrzanko.mobile_6vkusov.R.id.menu_search);
        search = menu.findItem(by.netbix.alexandrzanko.mobile_6vkusov.R.id.menu_filter);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == by.netbix.alexandrzanko.mobile_6vkusov.R.id.menu_filter) {
            if(!menuFilterOpen){
