...
import by.netbix.alexandrzanko.mobile_6vkusov.Adapters.CategoryListAdapter;
...
public class CategoriesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(by.netbix.alexandrzanko.mobile_6vkusov.R.layout.activity_categories);
        addToolBarToScreen();
        mainCategories = singleton.getStore().getMainCategories();
        secondaryCategories = singleton.getStore().getSecondaryCategories();
        listView = (ListView) findViewById(by.netbix.alexandrzanko.mobile_6vkusov.R.id.category_list);
    ...
    private void addToolBarToScreen() {
        ...
        toolbar.setTitle(by.netbix.alexandrzanko.mobile_6vkusov.R.string.categories_title);
