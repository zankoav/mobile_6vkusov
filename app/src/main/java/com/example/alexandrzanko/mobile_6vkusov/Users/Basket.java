...
public class Basket implements LoadJson {
                ...
                if (sessionName.equals("add")){
                    try {
                        ...
                        if (!empty){
                            ...
                            String url = Singleton.currentState().getStore().getContext().getResources().getString(R.string.api_base);
    ...
    public void initBasketFromRegisterUser(){
        if (Singleton.currentState().getUser().getStatus() == STATUS.REGISTER){
            String url = Singleton.currentState().getStore().getContext().getResources().getString(R.string.api_basket_items);
    ...
    private void addProduct(Product product){
        ...
        String url = Singleton.currentState().getStore().getContext().getResources().getString(R.string.api_add_variants);
        JSONObject params = new JSONObject();
        try {
    ...
    public void removeProductItem(ProductItem item){
        if(Singleton.currentState().getUser().getStatus() == STATUS.REGISTER){
            ...
            String url = Singleton.currentState().getStore().getContext().getResources().getString(R.string.api_remove_item);
            JSONObject params = new JSONObject();
            try {
                JSONObject userProfileJson = Singleton.currentState().getUser().getProfile();
                String session = userProfileJson.getString("session");
    ...
    public void minusProductItem(ProductItem item){
        if(Singleton.currentState().getUser().getStatus() == STATUS.REGISTER){
            ...
            String url = Singleton.currentState().getStore().getContext().getResources().getString(R.string.api_remove_variant);
            JSONObject params = new JSONObject();
            try {
                JSONObject userProfileJson = Singleton.currentState().getUser().getProfile();
                String session = userProfileJson.getString("session");
