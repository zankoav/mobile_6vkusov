...
public class GetPointsFragment extends Fragment implements LoadJson {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_get_points_layout, container, false);
        ...
        text = (TextView)rootView.findViewById(R.id.call_friend);
        return rootView;
    ...
    public void loadComplete(JSONObject obj, String sessionName) {
        if (obj != null) {
            ...
            Toast toast = Toast.makeText(getContext(),this.getResources().getString(R.string.error_server), Toast.LENGTH_SHORT);
            toast.show();
            btn.setEnabled(true);
        }
    ...
    private void getFriends() {
        ...
        if(Validation.email(email)){
            ...
            Toast toast = Toast.makeText(this.getContext(),this.getResources().getString(R.string.error_email), Toast.LENGTH_SHORT);
            toast.show();
            btn.setEnabled(true);
        }
    }
